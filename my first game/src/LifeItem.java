...
public class LifeItem {
	...
	public LifeItem(Vector2f startPosition)
	{
	...
	{
		m_powerPicture = new Image("data/LifeItemImage.png");
	...
	{ 
		...
		m_itemvis = (timer > 5000) && ( timer < 11000);
		m_itemvis2 = ( timer > 20000) && ( timer < 25000);
		m_itemvis3 = (timer > 50000) && ( timer < 55000);
