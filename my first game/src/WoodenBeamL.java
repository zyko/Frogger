...
public class WoodenBeamL {
	...
	private Vector2f m_movingBeamRight;

	
	public WoodenBeamL(Vector2f startPosition, Vector2f endPosition)
	{
	...
	{
		m_beamImage = new Image("data/woodenBeamLargeImage.jpg");
	...
	public void Update(int millisPassed)
	{
		...
		m_movingBeamRight = m_headingVector.copy();
		m_movingBeamRight.scale(localWayDelta);
	...
	public Vector2f getMovingBeamRight()
	{
		return m_movingBeamRight;
	}
